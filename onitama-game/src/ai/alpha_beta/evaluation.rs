...
impl Evaluation {
    pub fn evaluate(
        ...
        let enemy_distance_to_temple = Self::manhattan_distance(enemy_king_pos, my_temple as u32);
        let my_distance_to_temple = Self::manhattan_distance(my_king_pos, enemy_temple as u32);
    ...
    fn manhattan_distance(from: u32, to: u32) -> i32 {
